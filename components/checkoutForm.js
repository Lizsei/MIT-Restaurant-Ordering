...
// Added onOrderSuccess prop to function arguments
function CheckoutForm({ onOrderSuccess }) {
  ...
  async function submitOrder() {
    ...
    console.log("Preparing to submit order");  // Log before API call
    ...
    if (response.ok) {
      ...
      console.log("Order submitted successfully");  // Log after successful API call

      if (onOrderSuccess) {
        onOrderSuccess();  // Call onOrderSuccess when the order succeeds
      }
    } else {
      console.log("Order submission failed");  // Log after failed API call
